...
public class OrderDetail {
    ...
    @JoinColumn(name = "idOrder", referencedColumnName = "idOrder", nullable = false, foreignKey = @ForeignKey(name = "fk_order_detail_order"))
    private Order order;

    @OneToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "idProduct", referencedColumnName = "idProduct", nullable = false, foreignKey = @ForeignKey(name = "fk_order_detail_product"))
    ...
    @OneToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "idUser", referencedColumnName = "idUser", nullable = false, foreignKey = @ForeignKey(name = "fk_order_detail_user"))
    private User user;
